...
`grafify` also offers `scale_fill_grafify`, `scale_fill_grafify_c` and `scale_colour_grafify`, `scale_colour_grafify_c` to apply all `grafify` palettes to any `ggplot2` object.
