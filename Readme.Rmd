...
`grafify` is now on CRAN, can be installed by typing `install.packages("grafify")`.

Any updates not yet on can will be made available on here first for which you'll need the `remotes` package. Type `remotes::install_github("ashenoy-cmbi/grafify@*release")` to get the version on GitHub instead.
