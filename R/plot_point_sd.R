...
plot_point_sd <- function(data, xcol, ycol, s_alpha = 1, symsize = 3.5, symthick = 1, ewid = 0.2, ColPal = c("okabe_ito", "all_grafify", "bright",  "contrast",  "dark",  "fishy",  "kelly",  "light",  "muted",  "pale",  "r4",  "safe",  "vibrant"), ColSeq = TRUE, ColRev = FALSE, TextXAngle = 0, fontsize = 20){
