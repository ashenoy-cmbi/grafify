...
#' plot_befafter_colors(data = data_cholesterol, 
#' xcol = Treatment, ycol = Cholesterol, 
#' groups = Subject)
#'


plot_befafter_colors <- function(data, xcol, ycol, groups, symsize = 3, symthick = 1, s_alpha = 1, ColPal = "all_grafify", ColSeq = TRUE, ColRev = FALSE, TextXAngle = 0, fontsize = 20){
