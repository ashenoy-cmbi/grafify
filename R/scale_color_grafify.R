...
#'                        theme_classic()
#'                        
scale_color_grafify <- function(palette = c("okabe_ito", "all_grafify", "bright",  "contrast",  "dark",  "fishy",  "kelly",  "light",  "muted",  "pale",  "r4",  "safe",  "vibrant"), ColSeq = TRUE, reverse = FALSE, ...){
  ...
  discrete_scale("color", paste0("graf_", palette), palette = pal, ...)
}
